...
const InstructionsCash = ({dataInstructionsCash}) => (
  <div className="instructions">
    ...
    <p className="instruction3"><span style={{...(dataInstructionsCash.instructions4 == '' ? {display:'none'} : {color:'#e0aa00', fontSize: '12px', fontWeight: 'bold'} )}}>(*)</span> {dataInstructionsCash.instructions4}</p>
  </div>
)
